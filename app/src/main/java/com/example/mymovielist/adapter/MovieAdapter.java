...
import com.example.mymovielist.fragment.FragmentFavoriteMovie;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder> {
    ...
    public MovieAdapter(FragmentActivity activity, ArrayList<ModelMovie> modelMovie, FragmentFavoriteMovie xSelectData) {
    }
